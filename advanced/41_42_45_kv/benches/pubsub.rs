...
fn pubsub(c: &mut Criterion) {
    ...
    runtime.block_on(async {
        ...
        // FIXME: 100 下报：Too many open files (os error 24)', advanced/41_42_45_kv/benches/pubsub.rs:56:36
        for _ in 0..2 {
