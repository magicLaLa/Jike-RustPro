...
use kv3::{start_client_with_config, ClientConfig, CommandRequest, KvError, ProstClientStream};
use tokio::time;
...
fn start_unsubscribe(mut stream: ProstClientStream<Compat<yamux::Stream>>, name: &str, id: u32) -> Result<(), KvError> {
